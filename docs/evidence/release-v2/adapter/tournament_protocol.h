/* Implemented mailbox ABI v2; host-drained event ring.
 ...
 * event_count is the monotonic producer cursor. gTournamentEventRead is the host
 * acknowledgment cursor; slot = sequence % capacity. Overflow fails closed.
 */
...
extern volatile u32 gTournamentEventRead;
#endif
